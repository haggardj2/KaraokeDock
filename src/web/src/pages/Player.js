...
function getYouTubeVideoId(url) {
  ...
  const normalizeVideoId = (candidate) =>
...
export default function Player() {
  ...
  const fadeBreakAudioTo = useCallback(
    (targetVolume, durationSeconds, onComplete) => {
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        _jsx("div", {
                          ...
                          children:
                            formatSingerName(upNext[0].requested_by) ||
                            "Anonymous",
                        }),
                        !hideSingerQueueEnabled &&
                          _jsxs("div", {
              ...
              : _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("p", {
                      ...
                      children: "Add your song from the request page!",
                    }),
        ...
        children: [
          ...
          !isYouTube &&
            ...
            _jsx("div", {
              ...
              children: _jsx("div", { className: "play-icon" }),
            }),
          renderOverlay(),
        ],
      }),
