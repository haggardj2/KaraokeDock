...
const LIBRARY_PARSE_MODE_OPTIONS = [
    {
...
export default function Admin() {
    ...
    const [libraryParseMode, setLibraryParseMode] = useState('discid-artist-title');
    ...
    const [cardState, setCardState] = useState(() => loadAdminCardState());
    ...
    return (_jsxs("div", { className: "admin-page", children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { className: "container", children: [banner && (_jsx("div", { className: `banner ${auth.isDefaultPassword ? 'warning' : banner.includes('✔') ? 'success' : ''}`, children: renderStatusMessage(banner) })), _jsxs("div", { className: "header", children: [_jsx("h1", { className: "header-title", children: "Admin Dashboard" }), _jsx("p", { className: "header-subtitle", children: "Manage your karaoke system settings and media libraries" })] }), !auth.isLoggedIn ? (_jsxs("div", { className: "card login-card", children: [_jsx("div", { className: "login-header", children: _jsxs("h2", { className: "login-title", children: [_jsx(MaterialIcon, { name: "lock", style: { fontSize: 24, verticalAlign: 'text-bottom', marginRight: 8 } }), "Admin Login"] }) }), oidcConfig?.passwordLoginEnabled !== false && (_jsxs("form", { onSubmit: handleLogin, children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { className: "form-label", children: "Username" }), _jsx("input", { className: "form-input", type: "text", value: loginUsername, onChange: (e) => setLoginUsername(e.target.value), autoComplete: "username", required: true })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { className: "form-label", children: "Password" }), _jsx("input", { className: "form-input", type: "password", value: loginPassword, onChange: (e) => setLoginPassword(e.target.value), placeholder: "Enter admin password", autoComplete: "current-password", required: true })] }), loginError && (_jsx("div", { className: "error-msg", children: loginError })), _jsx("button", { className: "btn primary", type: "submit", disabled: busy, style: { width: "100%" }, children: busy ? _jsxs(_Fragment, { children: [_jsx("span", { className: "loading-spinner" }), " Logging in..."] }) : 'Login' })] })), oidcConfig?.passwordLoginEnabled === false && !oidcConfig?.enabled && (_jsx("div", { className: "error-msg", style: { marginBottom: 16 }, children: "Username/password login is disabled and SSO is not enabled." })), loginError && oidcConfig?.passwordLoginEnabled === false && (_jsx("div", { className: "error-msg", style: { marginBottom: 16 }, children: loginError })), oidcConfig?.enabled && (_jsxs(_Fragment, { children: [oidcConfig?.passwordLoginEnabled !== false && (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0' }, children: [_jsx("div", { style: { flex: 1, height: 1, background: 'rgba(255,255,255,0.1)' } }), _jsx("span", { style: { color: 'var(--color-text-secondary)', fontSize: 13 }, children: "or" }), _jsx("div", { style: { flex: 1, height: 1, background: 'rgba(255,255,255,0.1)' } })] })), _jsx("a", { href: `${API_BASE}/api/auth/oidc/login?returnTo=%2Fadmin`, className: "btn", style: {
                                            ...
                                            boxSizing: 'border-box',
                                        }, children: oidcConfig.buttonText })] }))] })) : !auth.isAdmin ? (_jsxs("div", { className: "card", style: { maxWidth: 480, margin: '80px auto', textAlign: 'center' }, children: [_jsx(MaterialIcon, { name: "block", style: { fontSize: 64, marginBottom: 16 } }), _jsx("h2", { style: { margin: '0 0 12px', fontSize: 22 }, children: "Access Denied" }), _jsx("p", { style: { color: 'var(--color-text-secondary)', marginBottom: 24 }, children: "Your account does not have administrator privileges." }), _jsxs("button", { className: "btn danger", onClick: auth.handleLogout, children: [_jsx(MaterialIcon, { name: "logout" }), " Logout"] })] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "card", children: [_jsxs("h2", { style: { margin: "0 0 20px", fontSize: 20 }, children: [_jsx(MaterialIcon, { name: "bar_chart", style: { fontSize: 24, verticalAlign: 'text-bottom', marginRight: 8 } }), "System Statistics"] }), _jsxs("div", { className: "stats-grid", children: [_jsxs("div", { className: "stat-pill", children: [_jsx(MaterialIcon, { name: "mic_external_on", className: "stat-icon" }), _jsx("span", { className: "stat-value", children: stats?.artists ?? "—" }), _jsx("span", { className: "stat-label", children: "Artists" })] }), _jsxs("div", { className: "stat-pill", children: [_jsx(MaterialIcon, { name: "music_note", className: "stat-icon" }), _jsx("span", { className: "stat-value", children: stats?.tracks ?? "—" }), _jsx("span", { className: "stat-label", children: "Tracks" })] }), _jsxs("div", { className: "stat-pill", children: [_jsx(MaterialIcon, { name: "queue_music", className: "stat-icon" }), _jsx("span", { className: "stat-value", children: stats?.queued ?? "—" }), _jsx("span", { className: "stat-label", children: "Queued" })] }), _jsxs("div", { className: "stat-pill", children: [_jsx(MaterialIcon, { name: "schedule", className: "stat-icon" }), _jsx("span", { className: "stat-value", style: { fontSize: 14 }, children: stats?.lastScan?.finishedAt
                                                            ? new Date(stats.lastScan.finishedAt).toLocaleDateString()
                                                            : "Never" }), _jsx("span", { className: "stat-label", children: "Last Scan" })] })] }), _jsxs("div", { style: { display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 20 }, children: [_jsx("button", { className: "btn-icon primary", onClick: scanAll, disabled: busy || !auth.sessionToken || !auth.isLoggedIn, title: "Scan all libraries", "aria-label": "Scan all libraries", children: _jsx(MaterialIcon, { name: "search" }) }), _jsx("button", { className: "btn-icon danger", onClick: clearDb, disabled: busy || !auth.sessionToken || !auth.isLoggedIn, title: "Clear database", "aria-label": "Clear database", children: _jsx(MaterialIcon, { name: "delete" }) }), _jsx("button", { className: "btn-icon", onClick: refreshStats, disabled: !auth.sessionToken || !auth.isLoggedIn, title: "Refresh stats", "aria-label": "Refresh stats", children: _jsx(MaterialIcon, { name: "refresh" }) })] })] }), _jsxs("div", { className: "card", children: [_jsxs("div", { className: "card-header", onClick: () => updateCardState('mediaLibrariesExpanded', !mediaLibrariesExpanded), children: [_jsxs("h2", { children: [_jsx(MaterialIcon, { name: "library_music", style: { fontSize: 24, verticalAlign: 'text-bottom', marginRight: 8 } }), "Media Libraries"] }), _jsx("button", { className: "card-toggle", type: "button", children: mediaLibrariesExpanded ? _jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "expand_less", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 4 } }), "Collapse"] }) : _jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "play_arrow", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 4 } }), "Expand"] }) })] }), _jsxs("div", { className: `card-content ${mediaLibrariesExpanded ? 'expanded' : 'collapsed'}`, children: [_jsx("div", { style: { marginBottom: 16, display: 'flex', justifyContent: 'flex-end' }, children: _jsx("button", { className: "btn-icon primary", title: "Add media library", "aria-label": "Add media library", onClick: () => {
                                                        resetLibraryForm();
                                                        setShowAddLibraryModal(true);
                                                    }, disabled: !auth.sessionToken || !auth.isLoggedIn, children: _jsx(MaterialIcon, { name: "add" }) }) }), libs.length > 0 ? (_jsx("div", { className: "library-list", children: libs.map((l, index) => (_jsx("div", { className: "library-item", style: { animationDelay: `${index * 0.05}s` }, children: _jsxs("div", { className: "library-header", children: [_jsxs("div", { className: "library-info", children: [_jsx("div", { className: "library-name", children: l.name }), _jsxs("div", { className: "library-path", children: [_jsx(MaterialIcon, { name: "folder", style: { fontSize: 16, verticalAlign: 'text-bottom', marginRight: 4 } }), l.path] }), _jsxs("div", { className: "library-path", children: [_jsx(MaterialIcon, { name: "sell", style: { fontSize: 16, verticalAlign: 'text-bottom', marginRight: 4 } }), LIBRARY_PARSE_MODE_OPTIONS.find((option) => option.value === l.parseMode)?.label ?? l.parseMode] })] }), _jsxs("div", { className: "library-actions", children: [_jsx("button", { className: "btn-icon primary", onClick: () => scanOne(l.id), disabled: busy || !auth.sessionToken || !auth.isLoggedIn, title: "Scan this library", children: _jsx(MaterialIcon, { name: "search" }) }), _jsx("button", { className: "btn-icon danger", onClick: () => deleteLibrary(l.id), disabled: busy || !auth.sessionToken || !auth.isLoggedIn, title: "Remove library", children: _jsx(MaterialIcon, { name: "delete" }) })] })] }) }, l.id))) })) : (_jsxs("div", { className: "empty-state", children: [_jsx(MaterialIcon, { name: "folder", className: "empty-icon" }), _jsx("div", { className: "empty-text", children: "No libraries configured yet" }), _jsx("div", { className: "empty-subtext", children: "Use the add button to create your first media library" })] }))] })] }), _jsxs("div", { className: "card", children: [_jsxs("div", { className: "card-header", onClick: () => updateCardState('breakMusicExpanded', !breakMusicExpanded), children: [_jsxs("h2", { children: [_jsx(MaterialIcon, { name: "music_note", style: { fontSize: 24, verticalAlign: 'text-bottom', marginRight: 8 } }), "Break Music"] }), _jsx("button", { className: "card-toggle", type: "button", children: breakMusicExpanded ? _jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "expand_less", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 4 } }), "Collapse"] }) : _jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "play_arrow", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 4 } }), "Expand"] }) })] }), _jsxs("div", { className: `card-content ${breakMusicExpanded ? 'expanded' : 'collapsed'}`, children: [_jsxs("div", { style: { marginBottom: 16, display: 'flex', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' }, children: [_jsxs("div", { style: { display: 'flex', gap: 10, flexWrap: 'wrap' }, children: [_jsx("button", { className: "btn-icon primary", onClick: () => scanBreakMusic(), disabled: busy, title: "Scan all break music folders", children: _jsx(MaterialIcon, { name: "search" }) }), _jsx("button", { className: "btn-icon danger", onClick: clearBreakMusicDb, disabled: busy, title: "Clear break music tracks from database", children: _jsx(MaterialIcon, { name: "cleaning_services" }) })] }), _jsx("button", { className: "btn-icon primary", onClick: () => {
                                                            resetBreakFolderForm();
                                                            setShowAddBreakFolderModal(true);
                                                        }, disabled: !auth.sessionToken || !auth.isLoggedIn, title: "Add break music folder", "aria-label": "Add break music folder", children: _jsx(MaterialIcon, { name: "add" }) })] }), _jsxs("div", { style: {
                                                    background: "var(--color-bg-secondary)",
                                                    border: "1px solid var(--color-border)",
                                                    borderRadius: 12,
                                                    padding: 16,
                                                    marginBottom: 16
                                                }, children: [_jsxs("h3", { style: { margin: "0 0 12px", fontSize: 16 }, children: [_jsx(MaterialIcon, { name: "save", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), "Saved Playlists Folder"] }), _jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("input", { className: "form-input", value: breakPlaylistsFolder, onChange: (e) => setBreakPlaylistsFolder(e.target.value), placeholder: "/media/playlists" }), _jsx("button", { className: "btn-icon", onClick: openBreakPlaylistsBrowser, disabled: !auth.sessionToken || !auth.isLoggedIn, title: "Browse playlist folders", children: _jsx(MaterialIcon, { name: "folder" }) }), _jsx("button", { className: "btn-icon primary", onClick: handleBreakPlaylistsFolderChange, disabled: busy || !breakPlaylistsFolder.trim(), title: "Save playlists folder", children: _jsx(MaterialIcon, { name: "save" }) })] })] }), breakFolders.length > 0 ? (_jsx("div", { className: "library-list", children: breakFolders.map((f) => (_jsx("div", { className: "library-item", children: _jsxs("div", { className: "library-header", children: [_jsxs("div", { className: "library-info", children: [_jsx("div", { className: "library-name", children: f.name }), _jsxs("div", { className: "library-path", children: [_jsx(MaterialIcon, { name: "folder", style: { fontSize: 16, verticalAlign: 'text-bottom', marginRight: 4 } }), f.path] })] }), _jsxs("div", { className: "library-actions", children: [_jsx("button", { className: "btn-icon primary", onClick: () => scanBreakMusic(f.id), disabled: busy, title: "Scan this folder", children: _jsx(MaterialIcon, { name: "search" }) }), _jsx("button", { className: "btn-icon danger", onClick: () => deleteBreakFolder(f.id), disabled: busy, title: "Remove folder", children: _jsx(MaterialIcon, { name: "delete" }) })] })] }) }, f.id))) })) : (_jsxs("div", { className: "empty-state", children: [_jsx(MaterialIcon, { name: "music_note", className: "empty-icon" }), _jsx("div", { className: "empty-text", children: "No break music folders configured" })] }))] })] }), _jsxs("div", { className: "card", children: [_jsxs("div", { className: "card-header", onClick: () => updateCardState('systemSettingsExpanded', !systemSettingsExpanded), children: [_jsxs("h2", { children: [_jsx(MaterialIcon, { name: "settings", style: { fontSize: 24, verticalAlign: 'text-bottom', marginRight: 8 } }), "System Settings"] }), _jsx("button", { className: "card-toggle", type: "button", children: systemSettingsExpanded ? _jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "expand_less", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 4 } }), "Collapse"] }) : _jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "play_arrow", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 4 } }), "Expand"] }) })] }), _jsxs("div", { className: `card-content ${systemSettingsExpanded ? 'expanded' : 'collapsed'}`, children: [_jsxs("div", { style: {
                                                    background: "var(--color-bg-secondary)",
                                                    border: "1px solid var(--color-border)",
                                                    borderRadius: 12,
                                                    padding: 16,
                                                    marginBottom: 16
                                                }, children: [_jsxs("h3", { style: { margin: "0 0 12px", fontSize: 16 }, children: [_jsx(MaterialIcon, { name: "library_music", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), "Library Availability & Requests"] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [_jsxs("label", { style: { display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }, children: [_jsx("input", { type: "checkbox", checked: !localLibraryEnabled && !externalLibraryEnabled, onChange: (e) => {
                                                    ...
                                                    padding: 16
                                                            ...
                                                            })] })] }), browseError && (_jsxs("div", { className: "error-msg", children: [_jsx(MaterialIcon, { name: "warning", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), browseError] })), _jsxs("div", { className: "browser-container", children: [currentBrowsePath !== "/" && (_jsxs("div", { className: "folder-item", onClick: navigateUp, children: [_jsx(MaterialIcon, { name: "arrow_upward", className: "folder-icon" }), _jsx("span", { className: "folder-name", children: ".." }), _jsx("span", { style: { opacity: 0.5, fontSize: 13 }, children: "(parent directory)" })] })), folderContents
                                                        .filter((item) => item.isDirectory)
                                                        .map((item) => (_jsxs("div", { className: "folder-item", onClick: () => browseFolders(item.path), children: [_jsx(MaterialIcon, { name: "folder", className: "folder-icon" }), _jsx("span", { className: "folder-name", children: item.name })] }, item.path))), folderContents.filter((item) => item.isDirectory).length ===
                                                        0 &&
                                                        !browseError && (_jsxs("div", { className: "empty-state", style: { padding: 40 }, children: [_jsx(MaterialIcon, { name: "folder_open", className: "empty-icon", style: { fontSize: 48 } }), _jsx("div", { className: "empty-text", style: { fontSize: 14 }, children: "No subfolders in this directory" })] }))] }), _jsxs("div", { style: { display: 'flex', gap: 12 }, children: [_jsx("input", { className: "form-input", value: currentBrowsePath, readOnly: true, style: { flex: 1 } }), _jsxs("button", { className: "btn success", onClick: () => selectFolder(currentBrowsePath), children: [_jsx(MaterialIcon, { name: "check" }), " Select This Folder"] }), _jsx("button", { className: "btn ghost", onClick: () => setShowBrowser(false), children: "Cancel" })] })] })] })), showDownloadBrowser && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: () => setShowDownloadBrowser(false) }), _jsxs("div", { className: "modal", children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { className: "modal-title", children: [_jsx(MaterialIcon, { name: "folder", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), "Select Download Folder"] }), _jsx("button", { className: "btn ghost", onClick: () => setShowDownloadBrowser(false), style: { padding: "4px 12px" }, children: _jsx(MaterialIcon, { name: "close" }) })] }), _jsxs("div", { className: "browser-path", children: [_jsx(MaterialIcon, { name: "location_on" }), _jsxs("div", { className: "breadcrumb", children: [_jsx("span", { className: "breadcrumb-part", onClick: () => browseFolders("/"), children: "/" }), currentBrowsePath
                                                                .split("/")
                                                                .filter(Boolean)
                                                                .map((part, idx, arr) => {
                                                                const partPath = "/" + arr.slice(0, idx + 1).join("/");
                                                        ...
                                                        .map((item) => (_jsxs("div", { className: "folder-item", onClick: () => browseFolders(item.path), children: [_jsx(MaterialIcon, { name: "folder", className: "folder-icon" }), _jsx("span", { className: "folder-name", children: item.name })] }, item.path))), folderContents.filter((item) => item.isDirectory).length ===
                                                        0 &&
                                                        !browseError && (_jsxs("div", { className: "empty-state", style: { padding: 40 }, children: [_jsx(MaterialIcon, { name: "folder_open", className: "empty-icon", style: { fontSize: 48 } }), _jsx("div", { className: "empty-text", style: { fontSize: 14 }, children: "No subfolders in this directory" })] }))] }), _jsxs("div", { style: { display: "flex", gap: 12 }, children: [_jsx("input", { className: "form-input", value: currentBrowsePath, readOnly: true, style: { flex: 1 } }), _jsxs("button", { className: "btn success", onClick: () => selectDownloadFolder(currentBrowsePath), children: [_jsx(MaterialIcon, { name: "check" }), " Select This Folder"] }), _jsx("button", { className: "btn ghost", onClick: () => setShowDownloadBrowser(false), children: "Cancel" })] })] })] })), showAccountManagement && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: () => setShowAccountManagement(false) }), _jsxs("div", { className: "modal", children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { className: "modal-title", children: [_jsx(MaterialIcon, { name: "lock", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), "Account Settings"] }), _jsx("button", { className: "btn ghost", onClick: () => setShowAccountManagement(false), style: { padding: "4px 12px" }, children: _jsx(MaterialIcon, { name: "close" }) })] }), auth.isDefaultPassword && (_jsxs("div", { className: "banner warning", style: { marginBottom: 16 }, children: [_jsx(MaterialIcon, { name: "warning", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), "You are using the default password. Please change it for security."] })), _jsx("p", { style: { color: "var(--color-text-secondary)", marginBottom: 20, fontSize: 14 }, children: "Change your username and password." }), !changingUsername && !changingPassword && (_jsxs("div", { style: { display: "flex", justifyContent: "space-between", gap: 12, marginBottom: 20 }, children: [_jsxs("button", { className: "btn", style: { minWidth: 180, justifyContent: "center", flex: 1 }, onClick: () => setChangingUsername(true), children: [_jsx(MaterialIcon, { name: "person" }), " Change Username"] }), _jsxs("button", { className: "btn", style: { minWidth: 180, justifyContent: "center", flex: 1 }, onClick: () => setChangingPassword(true), children: [_jsx(MaterialIcon, { name: "lock" }), " Change Password"] })] })), changingUsername && (_jsx("div", { style: { marginBottom: 20 }, children: _jsxs("form", { onSubmit: handleChangeUsername, style: {
                                                        display: "flex",
