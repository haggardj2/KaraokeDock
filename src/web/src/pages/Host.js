...
function MaterialIcon({ name, className = '', style, }) {
    return (_jsx("span", { className: `material-symbols-rounded${className ? ` ${className}` : ''}`, "aria-hidden": "true", style: style, children: name }));
}
function renderStatusMessage(message) {
    if (message.startsWith('⚠️')) {
        return (_jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "warning", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), message.replace(/^⚠️\s*/, '')] }));
    }
    if (message.startsWith('✔')) {
        return (_jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "check_circle", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), message.replace(/^✔\s*/, '')] }));
    }
    return message;
}
...
export default function Host() {
    ...
    function formatRequestedAt(dateStr) {
        if (!dateStr)
            return null;
        const d = new Date(dateStr);
    ...
    function renderDiscIdTag(discId) {
        if (!discId)
            return null;
    ...
    function renderReplaceButton(song, label = 'Replace song') {
        return (_jsx("button", { className: "control-btn", type: "button", title: label, "aria-label": label, disabled: busy, onClick: () => openReplaceSong(song), style: { padding: '6px 10px', fontSize: 13, lineHeight: 1 }, children: _jsx("span", { className: "material-symbols-rounded", style: { fontSize: 18, display: 'block' }, children: "contract_edit" }) }));
    }
    function canReplaceQueueSong(song) {
                ...
                wsRef.current.onmessage = (ev) => {
                    try {
                        ...
                        if (msg.type === 'queue.updated' ||
                            ...
                            const fallbackMessage = typeof msg.message === 'string' && msg.message.trim()
                                ? msg.message
                                            ...
                                            return sorted.map((singer, idx) => {
                                                ...
                                                return (_jsx("div", { draggable: true, onDragStart: () => handleSingerDragStart(singer.singerId), onDragEnd: handleSingerDragEnd, onDragOver: e => handleSingerDragOver(e, singer.singerId), onDragLeave: () => setSingerDragOverId(null), onDrop: e => handleSingerDrop(e, singer.singerId), style: {
                                                        ...
                                                        transition: 'border-color 0.15s, background 0.15s',
                                                                    ...
                                                                    flex: '0 0 auto',
                                                                    fontSize: 14,
                                                                }, children: isSinging ? _jsx(MaterialIcon, { name: "mic_external_on", style: { fontSize: 18 } }) : idx + 1 }), _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { style: { fontWeight: 700, fontSize: 16, color: isSinging ? 'rgba(16,185,129,1)' : 'var(--color-text-primary)', display: 'flex', alignItems: 'center', gap: 8 }, children: [singer.displayName, isSinging && (_jsx("span", { style: { fontSize: 11, fontWeight: 600, padding: '2px 8px', borderRadius: 99, background: 'rgba(16,185,129,0.2)', color: 'rgba(16,185,129,1)', letterSpacing: 0.5, textTransform: 'uppercase' }, children: "Now Singing" }))] }), _jsx("div", { style: { fontSize: 13, color: 'var(--color-text-secondary)', marginTop: 2 }, children: singer.nextSong
                                                                            ? _jsxs(_Fragment, { children: [_jsx("strong", { style: { color: 'var(--color-text-primary)' }, children: isSinging ? 'Singing:' : 'Next:' }), " ", singer.nextSong.title || 'Unknown', " \u2014 ", singer.nextSong.artist || 'Unknown', renderDiscIdTag(singer.nextSong.discId)] })
                                                                            : _jsx("span", { style: { opacity: 0.6 }, children: "No queued song" }) }), _jsxs("div", { style: { display: 'flex', gap: 16, marginTop: 4, fontSize: 12, color: 'var(--color-text-muted)' }, children: [_jsxs("span", { children: [_jsx(MaterialIcon, { name: "music_note", style: { fontSize: 14, verticalAlign: 'text-bottom', marginRight: 3 } }), singer.queuedSongsCount, " queued"] }), _jsxs("span", { children: [_jsx(MaterialIcon, { name: "check_circle", style: { fontSize: 14, verticalAlign: 'text-bottom', marginRight: 3 } }), singer.totalSongsSung, " sang"] }), singer.lastSangAt && _jsxs("span", { children: [_jsx(MaterialIcon, { name: "schedule", style: { fontSize: 14, verticalAlign: 'text-bottom', marginRight: 3 } }), formatTimeAgo(singer.lastSangAt)] })] })] }), _jsxs("div", { style: { display: 'flex', gap: 6, flex: '0 0 auto' }, children: [_jsx("button", { className: "control-btn", title: "View singer queue and history", onClick: () => openSingerModal(singer.singerId), style: { padding: '6px 10px', fontSize: 16, lineHeight: 1 }, children: _jsx(MaterialIcon, { name: "visibility" }) }), _jsx("button", { className: "control-btn danger", title: "Remove singer from rotation", disabled: busy, onClick: () => removeSingerFromRotation(singer.singerId), style: { padding: '6px 10px', fontSize: 13 }, children: _jsx(MaterialIcon, { name: "close" }) })] })] }) }, singer.singerId));
                                            });
                                        })() })), !queueState && queue.length > 0 && (_jsxs("div", { style: { marginTop: 16 }, children: [_jsx("div", { style: { color: 'var(--color-text-secondary)', fontSize: 13, marginBottom: 8 }, children: "(Flat queue \u2014 singer grouping unavailable)" }), queue.map(item => (_jsxs("div", { className: `queue-item ${item.status === 'playing' ? 'playing' : ''}`, children: [_jsx("span", { style: { fontWeight: 600 }, children: item.requested_by }), ' — ', item.title, renderDiscIdTag(item.disc_id), " by ", item.artist] }, item.id)))] }))] }), historyManagerOpen && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: closeHistoryManager }), _jsxs("div", { className: "modal", role: "dialog", "aria-modal": "true", "aria-labelledby": "history-manager-title", style: { maxWidth: 560 }, children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { id: "history-manager-title", style: { margin: 0, display: 'flex', alignItems: 'center', gap: 10 }, children: [_jsx("span", { className: "material-symbols-rounded", "aria-hidden": "true", children: "manage_history" }), "Singer History"] }), _jsx("button", { className: "control-btn", style: { width: 40, height: 40, padding: 0 }, onClick: closeHistoryManager, "aria-label": "Close singer history manager", children: _jsx(MaterialIcon, { name: "close" }) })] }), historyManagerMode === 'menu' && (_jsxs("div", { style: { display: 'grid', gap: 12 }, children: [_jsx("button", { className: "control-btn primary", type: "button", disabled: busy, onClick: () => setHistoryManagerMode('export'), style: { justifyContent: 'center', padding: '14px 18px' }, children: "Export Singer History" }), _jsx("button", { className: "control-btn", type: "button", disabled: busy, onClick: () => setHistoryManagerMode('import'), style: { justifyContent: 'center', padding: '14px 18px' }, children: "Import Singer History" })] })), historyManagerMode === 'export' && (_jsxs("div", { style: { display: 'grid', gap: 16 }, children: [_jsx("div", { style: { color: 'var(--color-text-secondary)', fontSize: 14 }, children: "Choose active singers to export, or export all singer history." }), _jsxs("div", { style: { display: 'flex', gap: 8, flexWrap: 'wrap' }, children: [_jsx("button", { className: "control-btn primary", type: "button", disabled: busy, onClick: () => void exportAllSingerHistory(), children: "Export All Singers" }), _jsx("button", { className: "control-btn", type: "button", disabled: busy || historyExportSelectedSingerIds.size === 0, onClick: () => void exportSelectedSingerHistory(), children: "Export Selected" }), _jsx("button", { className: "control-btn", type: "button", disabled: busy, onClick: () => setHistoryExportSelectedSingerIds(new Set((queueState?.queueOrder ?? []).map((singer) => singer.singerId))), children: "Select All Active" })] }), (queueState?.queueOrder.length ?? 0) === 0 ? (_jsx("div", { style: { color: 'var(--color-text-secondary)', padding: 16, textAlign: 'center' }, children: "No active singers to choose from. Use Export All Singers to export stored history." })) : (_jsx("div", { style: { display: 'grid', gap: 8, maxHeight: 320, overflowY: 'auto' }, children: (queueState?.queueOrder ?? []).map((singer) => (_jsxs("label", { style: {
                                                                display: 'flex',
                                                                alignItems: 'center',
                                                                gap: 10,
                                                                padding: 12,
                                                                ...
                                                                cursor: 'pointer',
                                                                        ...
                                                                        cursor: 'pointer',
                                                                            ...
                                                                            } }), _jsx("span", { style: { flex: 1, fontWeight: 600 }, children: getKdSingerDisplayName(singer, index) }), _jsxs("span", { style: { color: 'var(--color-text-secondary)', fontSize: 12 }, children: [singer.songs?.length ?? 0, " songs"] })] }, `${getKdSingerDisplayName(singer, index)}-${index}`))) })] }))] }))] })] })), singerModalOpen && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: closeSingerModal }), _jsxs("div", { className: "modal", style: { maxWidth: 600 }, children: [_jsxs("div", { className: "modal-header", children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }, children: [_jsxs("h3", { style: { margin: 0 }, children: [_jsx(MaterialIcon, { name: "mic_external_on", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), selectedSingerHistory?.singer.displayName ?? (queueState?.queueOrder.find(s => s.singerId === selectedSingerId)?.displayName ?? 'Singer'), " \u2014 Queue & History"] }), selectedSingerHistory && (_jsx("button", { className: "control-btn", type: "button", title: "Edit singer name", "aria-label": "Edit singer name", style: { width: 36, height: 36, padding: 0, flexShrink: 0 }, onClick: openRenameSingerDialog, children: _jsx(MaterialIcon, { name: "edit" }) })), selectedSingerHistory && (_jsx("button", { className: "control-btn", type: "button", title: "Merge another singer into this one", "aria-label": "Merge singer", style: { width: 36, height: 36, padding: 0, flexShrink: 0 }, onClick: () => { setMergeSingerDialogOpen(true); setMergeSingerError(''); setMergeSingerQuery(''); }, children: _jsx(MaterialIcon, { name: "shuffle" }) })), selectedSingerHistory && (_jsx("button", { className: "control-btn", type: "button", title: "Add a song to this singer's queue", "aria-label": "Add song to queue", style: { width: 36, height: 36, padding: 0, flexShrink: 0 }, onClick: () => {
                                                                        ...
                                                                        return selectedSingerHistory.queuedSongs.map((song, i) => {
                                                                            ...
                                                                            return (_jsxs("tr", { draggable: isDraggable, onDragStart: () => isDraggable && setModalSongDraggedId(song.queueId), onDragEnd: () => setModalSongDraggedId(null), onDragOver: e => { if (isDraggable) {
                                                                                    ...
                                                                                    transition: 'background 0.15s',
                                                                                                ...
                                                                                                fontSize: 11,
                                                                                                fontWeight: 700,
                                                                                            }, children: i + 1 }) }), _jsxs("td", { style: { padding: '8px 6px', borderBottom: '1px solid var(--color-border)' }, children: [_jsx("div", { style: { fontWeight: 600, color: 'var(--color-text-primary)' }, children: song.title || 'Unknown' }), _jsxs("div", { style: { fontSize: 12, color: 'var(--color-text-secondary)' }, children: [song.artist || 'Unknown', renderDiscIdTag(song.discId)] }), song.requestedAt && (_jsxs("div", { style: { fontSize: 11, color: 'var(--color-text-muted)', marginTop: 2 }, children: ["Requested at: ", formatRequestedAt(song.requestedAt)] }))] }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', whiteSpace: 'nowrap', borderBottom: '1px solid var(--color-border)' }, children: song.keyAdjustment !== 0 && (_jsxs("span", { style: { fontSize: 11, color: 'var(--color-text-muted)' }, title: "Key adjustment", children: [_jsx(MaterialIcon, { name: "music_note", style: { fontSize: 12, verticalAlign: 'text-bottom', marginRight: 2 } }), song.keyAdjustment > 0 ? '+' : '', song.keyAdjustment] })) }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', borderBottom: '1px solid var(--color-border)' }, children: _jsx("span", { style: {
                                                                                                padding: '2px 8px',
                                                                                                borderRadius: 100,
                                                                                                fontSize: 11,
                                                                                                background: song.status === 'playing' ? 'rgba(16,185,129,0.2)' : 'rgba(99,102,241,0.15)',
                                                                                                color: song.status === 'playing' ? '#10b981' : 'var(--color-accent)',
                                                                                            }, title: song.status === 'playing' ? 'Playing' : 'Queued', children: _jsx(MaterialIcon, { name: song.status === 'playing' ? 'play_arrow' : 'music_note', style: { fontSize: 14 } }) }) }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', width: 80, borderBottom: '1px solid var(--color-border)' }, children: _jsxs("div", { style: { display: 'flex', gap: 6, justifyContent: 'center' }, children: [canReplaceQueueSong(song) && renderReplaceButton(song), song.status === 'queued' && (_jsx("button", { onClick: () => removeSongFromQueue(song.queueId), title: "Remove song from queue", style: {
                                                                                                        ...
                                                                                                        fontSize: 13,
                                                                                                        lineHeight: 1,
                                                                                                    }, children: _jsx(MaterialIcon, { name: "close", style: { fontSize: 14 } }) }))] }) })] }, song.queueId));
                                                                        });
                                                                            ...
                                                                            background: 'var(--color-bg-secondary)',
                                                                        }, children: [_jsxs("td", { style: { padding: '8px 10px', borderBottom: '1px solid var(--color-border)' }, children: [_jsx("div", { style: { fontWeight: 600, color: 'var(--color-text-primary)' }, children: song.title || 'Unknown' }), _jsxs("div", { style: { fontSize: 12, color: 'var(--color-text-secondary)' }, children: [song.artist || 'Unknown', renderDiscIdTag(song.discId)] }), song.requestedAt && (_jsxs("div", { style: { fontSize: 11, color: 'var(--color-text-muted)', marginTop: 2 }, children: ["Requested at: ", formatRequestedAt(song.requestedAt)] }))] }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', whiteSpace: 'nowrap', borderBottom: '1px solid var(--color-border)' }, children: song.completedAt && (_jsxs("span", { style: { fontSize: 11, color: 'var(--color-text-muted)' }, title: `Completed ${formatTimeAgo(song.completedAt)}`, children: [_jsx(MaterialIcon, { name: "schedule", style: { fontSize: 12, verticalAlign: 'text-bottom', marginRight: 2 } }), formatTimeAgo(song.completedAt)] })) }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', width: 36, borderBottom: '1px solid var(--color-border)' }, children: _jsx("span", { style: {
                                                                                        padding: '2px 8px',
                                                                                        borderRadius: 100,
                                                                                        fontSize: 11,
                                                                                        background: 'rgba(16,185,129,0.15)',
                                                                                        color: '#10b981',
                                                                                    }, title: "Completed", children: _jsx(MaterialIcon, { name: "check_circle", style: { fontSize: 14 } }) }) }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', width: 80, borderBottom: '1px solid var(--color-border)' }, children: _jsx("div", { style: { display: 'flex', gap: 6, justifyContent: 'center' }, children: _jsx("button", { className: "control-btn", style: { fontSize: 14, padding: '4px 8px', lineHeight: 1 }, disabled: busy, onClick: () => restoreSongToQueue(song.queueId), title: "Return this song to the queue", children: _jsx(MaterialIcon, { name: "keyboard_return" }) }) }) })] }, song.queueId))) }) })] })), (selectedSingerHistory.skippedSongs.length > 0 || selectedSingerHistory.removedSongs.length > 0) && (_jsxs("div", { children: [_jsx("div", { style: { fontWeight: 600, marginBottom: 8, color: 'var(--color-text-secondary)', textTransform: 'uppercase', fontSize: 11, letterSpacing: 1 }, children: "Skipped / Removed" }), _jsx("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: 13, opacity: 0.7 }, children: _jsx("tbody", { children: [...selectedSingerHistory.skippedSongs, ...selectedSingerHistory.removedSongs].map(song => (_jsxs("tr", { style: {
                                                                            background: 'var(--color-bg-secondary)',
                                                                        }, children: [_jsxs("td", { style: { padding: '8px 10px', borderBottom: '1px solid var(--color-border)' }, children: [_jsx("div", { style: { fontWeight: 600, color: 'var(--color-text-primary)' }, children: song.title || 'Unknown' }), _jsxs("div", { style: { fontSize: 12, color: 'var(--color-text-secondary)' }, children: [song.artist || 'Unknown', renderDiscIdTag(song.discId)] }), song.requestedAt && (_jsxs("div", { style: { fontSize: 11, color: 'var(--color-text-muted)', marginTop: 2 }, children: ["Requested at: ", formatRequestedAt(song.requestedAt)] }))] }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', width: 36, borderBottom: '1px solid var(--color-border)' }, children: _jsx("span", { style: {
                                                                                        padding: '2px 8px',
                                                                                        borderRadius: 100,
                                                                                        fontSize: 11,
                                                                                        background: 'rgba(239,68,68,0.15)',
                                                                                        color: '#ef4444',
                                                                                    }, title: song.status === 'skipped' ? 'Skipped' : 'Removed', children: _jsx(MaterialIcon, { name: song.status === 'skipped' ? 'skip_next' : 'close', style: { fontSize: 14 } }) }) }), _jsx("td", { style: { padding: '8px 6px', textAlign: 'center', width: 80, borderBottom: '1px solid var(--color-border)' }, children: _jsx("div", { style: { display: 'flex', gap: 6, justifyContent: 'center' }, children: _jsx("button", { className: "control-btn danger", style: { fontSize: 13, padding: '4px 8px', lineHeight: 1 }, disabled: busy, onClick: () => deleteSongFromHistory(song.queueId), title: "Remove this track from singer history", children: _jsx(MaterialIcon, { name: "close" }) }) }) })] }, song.queueId))) }) })] })), selectedSingerHistory.completedSongs.length === 0 &&
                                                        selectedSingerHistory.skippedSongs.length === 0 &&
                                                        selectedSingerHistory.removedSongs.length === 0 && (_jsx("div", { style: { color: 'var(--color-text-secondary)', textAlign: 'center', padding: '10px 0' }, children: "No sang history on record for this singer." }))] })) : (_jsx("div", { style: { color: 'var(--color-text-secondary)', textAlign: 'center', padding: '20px 0' }, children: "Could not load singer history." }))] }), renameSingerDialogOpen && selectedSingerHistory && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: closeRenameSingerDialog }), _jsxs("div", { className: "modal", style: { maxWidth: 460, zIndex: 1001 }, children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { style: { margin: 0 }, children: [_jsx(MaterialIcon, { name: "edit", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), "Edit Singer Name"] }), _jsx("button", { className: "control-btn", style: { width: 40, height: 40, padding: 0 }, onClick: closeRenameSingerDialog, children: _jsx(MaterialIcon, { name: "close" }) })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 14 }, children: [_jsxs("div", { children: [_jsx("label", { className: "form-label", style: { marginBottom: 6 }, children: "Singer Name" }), _jsx("input", { className: "form-input", value: editingSingerName, onChange: e => setEditingSingerName(e.target.value), onKeyDown: e => {
                                                                            if (e.key === 'Enter') {
                                                                                e.preventDefault();
                                                                                void renameSingerFromModal();
                                                                            }
                                                                        }, placeholder: "Enter singer name", autoFocus: true, disabled: savingSingerName })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'flex-end', gap: 10 }, children: [_jsx("button", { className: "control-btn", type: "button", onClick: closeRenameSingerDialog, disabled: savingSingerName, children: "Cancel" }), _jsx("button", { className: "control-btn primary", type: "button", onClick: () => void renameSingerFromModal(), disabled: savingSingerName || editingSingerName.trim() === selectedSingerHistory.singer.displayName, children: savingSingerName ? 'Saving…' : 'Update Name' })] })] })] })] })), mergeSingerDialogOpen && selectedSingerHistory && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: () => setMergeSingerDialogOpen(false) }), _jsxs("div", { className: "modal", style: { maxWidth: 460, zIndex: 1001 }, children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { style: { margin: 0 }, children: [_jsx(MaterialIcon, { name: "shuffle", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), "Merge Singer"] }), _jsx("button", { className: "control-btn", style: { width: 40, height: 40, padding: 0 }, onClick: () => setMergeSingerDialogOpen(false), children: _jsx(MaterialIcon, { name: "close" }) })] }), _jsxs("p", { style: { color: 'var(--color-text-secondary)', fontSize: 13, marginBottom: 12 }, children: ["Merge another singer's history and queue into ", _jsx("strong", { children: selectedSingerHistory.singer.displayName }), ". The other singer will be removed."] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 14 }, children: [_jsxs("div", { children: [_jsx("label", { className: "form-label", style: { marginBottom: 6 }, children: "Singer to merge (source)" }), _jsx("input", { className: "form-input", list: "merge-singer-list", value: mergeSingerQuery, onChange: e => { setMergeSingerQuery(e.target.value); setMergeSingerError(''); }, placeholder: "Type singer name\u2026", autoFocus: true, disabled: mergingSinger }), _jsx("datalist", { id: "merge-singer-list", children: (queueState?.queueOrder ?? []).filter(s => s.singerId !== selectedSingerId).map(s => (_jsx("option", { value: s.displayName }, s.singerId))) })] }), mergeSingerError && _jsx("div", { style: { color: '#ef4444', fontSize: 13 }, children: mergeSingerError }), _jsxs("div", { style: { display: 'flex', justifyContent: 'flex-end', gap: 10 }, children: [_jsx("button", { className: "control-btn", type: "button", onClick: () => setMergeSingerDialogOpen(false), disabled: mergingSinger, children: "Cancel" }), _jsx("button", { className: "control-btn primary", type: "button", onClick: () => void mergeSingerIntoTarget(), disabled: mergingSinger || !mergeSingerQuery.trim(), children: mergingSinger ? 'Merging…' : 'Merge' })] })] })] })] }))] })), showAccountManagement && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: () => setShowAccountManagement(false) }), _jsxs("div", { className: "modal", style: { maxWidth: 560 }, children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { style: { margin: 0 }, children: [_jsx(MaterialIcon, { name: "lock", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), "Account Settings"] }), _jsx("button", { className: "control-btn", style: { width: 40, height: 40, padding: 0 }, onClick: () => setShowAccountManagement(false), children: _jsx(MaterialIcon, { name: "close" }) })] }), auth.isDefaultPassword && (_jsxs("div", { className: "banner", style: { marginBottom: 16 }, children: [_jsx(MaterialIcon, { name: "warning", style: { fontSize: 18, verticalAlign: 'text-bottom', marginRight: 6 } }), "You are using the default password. Please change it for security."] })), _jsx("p", { style: { color: 'var(--color-text-secondary)', marginBottom: 20, fontSize: 14 }, children: "Change your username and password." }), !changingUsername && !changingPassword && (_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', gap: 12, marginBottom: 20 }, children: [_jsxs("button", { className: "control-btn", style: { minWidth: 180, justifyContent: 'center', flex: 1 }, onClick: () => setChangingUsername(true), children: [_jsx(MaterialIcon, { name: "person" }), " Change Username"] }), _jsxs("button", { className: "control-btn", style: { minWidth: 180, justifyContent: 'center', flex: 1 }, onClick: () => setChangingPassword(true), children: [_jsx(MaterialIcon, { name: "lock" }), " Change Password"] })] })), changingUsername && (_jsxs("form", { onSubmit: handleChangeUsername, style: {
                                                    display: 'flex',
                                                    ...
                                                    border: '1px solid var(--color-border)',
                                                            ...
                                                            borderRadius: '8px',
                                                            transition: 'all 0.3s ease'
                                                        }, onMouseEnter: e => e.currentTarget.style.background = 'var(--color-bg-hover)', onMouseLeave: e => e.currentTarget.style.background = 'transparent', onClick: () => setShowPlayerWindowControl(false), children: _jsx(MaterialIcon, { name: "close" }) })] }), _jsxs("div", { style: { flex: 1, overflowY: 'auto', minHeight: 0 }, children: [_jsxs("div", { className: "settings-section", children: [_jsx("div", { className: "settings-title", children: "Auto-play Settings" }), _jsxs("div", { style: {
                                                                    display: 'flex',
                                                                    alignItems: 'center',
                                                            ...
                                                            flexShrink: 0,
                                                                                    ...
                                                                                    color: 'var(--color-text-secondary)',
                                                                                    fontWeight: 600
                                                                                }, children: [_jsx("span", { style: { textAlign: 'center' }, children: _jsxs("button", { title: "Add all visible tracks to playlist", onClick: addAllBreakTracksToPlaylist, disabled: sortedFilteredBreakLibraryTracks.length === 0, style: { border: 'none', background: 'transparent', color: 'var(--color-text-secondary)', cursor: 'pointer', fontSize: 14, padding: 0 }, children: [_jsx(MaterialIcon, { name: "playlist_add", style: { fontSize: 15, verticalAlign: 'text-bottom', marginRight: 3 } }), "All"] }) }), breakColumnEnabled('song') && (_jsxs("div", { className: "break-table-header-cell", children: [_jsxs("button", { className: "break-table-header-sort", onClick: () => toggleBreakSort('song'), children: ["Song", breakSort.column === 'song' && _jsx(MaterialIcon, { name: breakSort.direction === 'asc' ? 'arrow_drop_up' : 'arrow_drop_down', style: { fontSize: 18, verticalAlign: 'text-bottom' } })] }), _jsx("div", { className: "break-table-header-resizer", onMouseDown: (event) => startBreakColumnResize('song', event) })] })), breakColumnEnabled('artist') && (_jsxs("div", { className: "break-table-header-cell", children: [_jsxs("button", { className: "break-table-header-sort", onClick: () => toggleBreakSort('artist'), children: ["Artist", breakSort.column === 'artist' && _jsx(MaterialIcon, { name: breakSort.direction === 'asc' ? 'arrow_drop_up' : 'arrow_drop_down', style: { fontSize: 18, verticalAlign: 'text-bottom' } })] }), _jsx("div", { className: "break-table-header-resizer", onMouseDown: (event) => startBreakColumnResize('artist', event) })] })), breakColumnEnabled('genre') && (_jsxs("div", { className: "break-table-header-cell", children: [_jsxs("button", { className: "break-table-header-sort", onClick: () => toggleBreakSort('genre'), children: ["Genre", breakSort.column === 'genre' && _jsx(MaterialIcon, { name: breakSort.direction === 'asc' ? 'arrow_drop_up' : 'arrow_drop_down', style: { fontSize: 18, verticalAlign: 'text-bottom' } })] }), _jsx("div", { className: "break-table-header-resizer", onMouseDown: (event) => startBreakColumnResize('genre', event) })] })), breakColumnEnabled('length') && (_jsxs("div", { className: "break-table-header-cell", children: [_jsxs("button", { className: "break-table-header-sort", onClick: () => toggleBreakSort('length'), children: ["Length", breakSort.column === 'length' && _jsx(MaterialIcon, { name: breakSort.direction === 'asc' ? 'arrow_drop_up' : 'arrow_drop_down', style: { fontSize: 18, verticalAlign: 'text-bottom' } })] }), _jsx("div", { className: "break-table-header-resizer", onMouseDown: (event) => startBreakColumnResize('length', event) })] })), breakColumnEnabled('path') && (_jsxs("div", { className: "break-table-header-cell", children: [_jsxs("button", { className: "break-table-header-sort", onClick: () => toggleBreakSort('path'), children: ["Path", breakSort.column === 'path' && _jsx(MaterialIcon, { name: breakSort.direction === 'asc' ? 'arrow_drop_up' : 'arrow_drop_down', style: { fontSize: 18, verticalAlign: 'text-bottom' } })] }), _jsx("div", { className: "break-table-header-resizer", onMouseDown: (event) => startBreakColumnResize('path', event) })] }))] }), sortedFilteredBreakLibraryTracks.map((track) => (_jsxs("div", { draggable: true, onDragStart: (ev) => {
                                                                        ...
                                                                        setBreakDraggedTrackId(null);
                                                                            ...
                                                                            return (_jsxs("div", { className: `break-playlist-row ${breakDraggedPlaylistIndex === index ? 'dragging' : ''} ${isCurrent ? 'current' : ''}`, draggable: true, onDragStart: () => {
                                                                                    ...
                                                                                    setBreakPlaylistTracksAndSync(next);
                                                                                    setBreakDraggedTrackId(null);
                                                                                }, children: [_jsx("span", { title: "Drag to reorder playlist", style: { color: 'var(--color-text-secondary)', cursor: 'grab', fontSize: 16, textAlign: 'center' }, children: _jsx(MaterialIcon, { name: "drag_indicator", style: { fontSize: 18 } }) }), _jsxs("div", { style: { minWidth: 0 }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 13, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: track.title }), isCurrent && (_jsx("span", { style: { fontSize: 11, border: '1px solid var(--color-border-focus)', borderRadius: 999, padding: '1px 8px', color: 'var(--color-accent-hover)' }, children: "Now Playing" }))] }), _jsxs("div", { style: { fontSize: 12, color: 'var(--color-text-secondary)' }, children: [track.artist || 'Unknown Artist', " \u2022 ", formatDurationMs(track.duration_ms)] })] }), _jsxs("div", { style: { display: 'flex', gap: 4 }, children: [_jsx("button", { title: "Move up", disabled: index === 0, onClick: () => moveBreakTrackInPlaylist(index, -1), style: { border: 'none', background: 'transparent', color: 'var(--color-text-primary)', cursor: 'pointer' }, children: _jsx(MaterialIcon, { name: "keyboard_arrow_up", style: { fontSize: 18 } }) }), _jsx("button", { title: "Move down", disabled: index === breakPlaylistTracks.length - 1, onClick: () => moveBreakTrackInPlaylist(index, 1), style: { border: 'none', background: 'transparent', color: 'var(--color-text-primary)', cursor: 'pointer' }, children: _jsx(MaterialIcon, { name: "keyboard_arrow_down", style: { fontSize: 18 } }) }), _jsx("button", { title: "Remove from playlist", onClick: () => removeBreakTrackFromPlaylist(index), style: { border: 'none', background: 'transparent', color: 'var(--color-danger)', cursor: 'pointer' }, children: _jsx(MaterialIcon, { name: "delete", style: { fontSize: 18 } }) })] })] }, `${track.id}-${index}`));
                                                                        }), breakPlaylistTracks.length === 0 && (_jsx("div", { style: { padding: 14, color: 'var(--color-text-secondary)' }, children: "Drag tracks from the library table here." }))] }) })] })] })] })] })), replacingId !== null && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: closeReplaceModal }), _jsxs("div", { className: "modal", children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { style: { margin: 0, display: 'flex', alignItems: 'center', gap: 8 }, children: [_jsx("span", { className: "material-symbols-rounded", style: { fontSize: 24 }, children: "contract_edit" }), "Replace Song"] }), _jsx("button", { style: {
                                                            background: 'transparent',
                                                            border: 'none',
                                                            color: 'var(--color-text-secondary)',
                                                            fontSize: 24,
                                                            ...
                                                            borderRadius: '8px',
                                                            transition: 'all 0.3s ease'
                                                        }, onMouseEnter: e => e.currentTarget.style.background = 'var(--color-bg-hover)', onMouseLeave: e => e.currentTarget.style.background = 'transparent', onClick: closeReplaceModal, children: _jsx(MaterialIcon, { name: "close" }) })] }), _jsxs("div", { className: "search-mode-toggle", children: [localLibraryEnabled && (_jsxs("button", { className: `mode-button ${replaceSearchMode === 'local' ? 'active' : ''}`, onClick: () => setReplaceSearchMode('local'), children: [_jsx(MaterialIcon, { name: "library_music", className: "mode-icon", style: { fontSize: 20, marginRight: 6 } }), "Local Library"] })), externalLibraryEnabled && (_jsxs("button", { className: `mode-button ${replaceSearchMode === 'karaoke-nerds' ? 'active karaoke-nerds' : ''}`, onClick: () => setReplaceSearchMode('karaoke-nerds'), children: [_jsx("img", { src: "https://karaokenerds.com/Content/Icons/favicon.ico", alt: "Karaoke Nerds", className: "mode-icon", style: { width: "20px", height: "20px", marginRight: "6px" } }), "Karaoke Nerds"] })), _jsxs("button", { className: `mode-button ${replaceSearchMode === 'url' ? 'active' : ''}`, onClick: () => setReplaceSearchMode('url'), children: [_jsx(MaterialIcon, { name: "link", style: { fontSize: 18, marginRight: 6 } }), " URL"] })] }), replaceSearchMode === 'url' ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { className: "form-label", children: "Video URL" }), _jsx("input", { className: "form-input", placeholder: "Enter YouTube or video URL...", value: replaceUrl, onChange: e => setReplaceUrl(e.target.value), autoFocus: true, style: {
                                                                    width: '100%',
                                                                    boxSizing: 'border-box',
                                                                    marginBottom: '16px'
                                                            ...
                                                            marginBottom: '16px'
                                                                ...
                                                                justifyContent: 'center',
                                                                minHeight: '200px'
                                                            }, children: searchQuery ? (_jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "search", style: { fontSize: 24, marginBottom: 12, opacity: 0.5 } }), _jsx("div", { style: { fontSize: '14px' }, children: replaceSearchMode === 'local' ? 'No local results found' : 'No Karaoke Nerds results found' }), _jsx("div", { style: { fontSize: '12px', marginTop: '4px', opacity: 0.7 }, children: "Try a different search term" })] })) : (_jsxs(_Fragment, { children: [_jsx(MaterialIcon, { name: "music_note", style: { fontSize: 32, marginBottom: 12, opacity: 0.3 } }), _jsxs("div", { style: { fontSize: '14px' }, children: ["Start typing to search ", replaceSearchMode === 'local' ? 'local library' : 'Karaoke Nerds'] })] })) })) : (_jsx(_Fragment, { children: replaceSearchMode === 'local' ? (
                                                            ...
                                                            searchResults.map((track, idx) => (_jsxs("div", { className: "search-result", onClick: () => replaceSongWithKaraokeNerds(replacingId, track), children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { style: { fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: track.title || 'Unknown' }), _jsxs("div", { style: { fontSize: 13, color: 'var(--color-text-secondary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: [track.artist || 'Unknown', track.brand && (_jsx("span", { style: {
                                                                                ...
                                                                                }, disabled: busy || downloadingTrack === track.url, title: "Download to local library", children: [downloadingTrack === track.url ? _jsx(MaterialIcon, { name: "hourglass_top", style: { fontSize: 16, verticalAlign: 'text-bottom', marginRight: 4 } }) : _jsx(MaterialIcon, { name: "download", style: { fontSize: 16, verticalAlign: 'text-bottom', marginRight: 4 } }), " Download"] })), _jsx("button", { className: "control-btn", style: {
                                                                                    padding: '6px 14px',
                                                                                    fontSize: '13px',
                                                                                    minWidth: '70px',
                                                                                    background: 'linear-gradient(135deg, #7c3aed, #a855f7)'
                                                    ...
                                                    background: 'transparent',
                                                    border: '2px solid var(--color-border)'
                                                }, onClick: closeReplaceModal, children: "Cancel" })] })] })), showManualRequest && (_jsxs(_Fragment, { children: [_jsx("div", { className: "modal-backdrop", onClick: resetManualRequestModal }), _jsxs("div", { className: "modal", children: [_jsxs("div", { className: "modal-header", children: [_jsxs("h3", { style: { margin: 0 }, children: [_jsx(MaterialIcon, { name: "add", style: { fontSize: 22, verticalAlign: 'text-bottom', marginRight: 8 } }), "Add to Queue"] }), _jsx("button", { style: {
                                                            background: 'transparent',
                                                            border: 'none',
                                                            color: 'var(--color-text-secondary)',
                                                            fontSize: 24,
                                                            ...
                                                            borderRadius: '8px',
                                                            transition: 'all 0.3s ease'
                                                        }, onMouseEnter: e => e.currentTarget.style.background = 'var(--color-bg-hover)', onMouseLeave: e => e.currentTarget.style.background = 'transparent', onClick: resetManualRequestModal, children: _jsx(MaterialIcon, { name: "close" }) })] }), manualRequestForSingerId ? (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', background: 'rgba(99,102,241,0.1)', borderRadius: 8, border: '1px solid rgba(99,102,241,0.2)' }, children: [_jsx("span", { style: { fontSize: 13, color: 'var(--color-text-secondary)' }, children: "Adding for:" }), _jsxs("strong", { style: { fontSize: 13 }, children: [_jsx(MaterialIcon, { name: "mic_external_on", style: { fontSize: 15, verticalAlign: 'text-bottom', marginRight: 3 } }), manualRequestName] })] })) : (_jsxs("div", { className: "form-group", style: { position: 'relative' }, children: [_jsx("label", { className: "form-label", children: "Singer Name (Optional)" }), _jsx("input", { className: "form-input", placeholder: "Enter singer name...", value: manualRequestName, autoComplete: "off", onChange: e => {
                                                            ...
                                                            }, children: [_jsx("span", { children: name }), _jsx("span", { className: "manual-singer-suggestion-hint", children: "Use existing singer" })] }, name))) }))] })), _jsxs("div", { className: "search-mode-toggle", children: [localLibraryEnabled && (_jsxs("button", { className: `mode-button ${manualRequestMode === 'local' ? 'active' : ''}`, onClick: () => setManualRequestMode('local'), children: [_jsx(MaterialIcon, { name: "library_music", className: "mode-icon", style: { fontSize: 20, marginRight: 6 } }), "Local"] })), externalLibraryEnabled && (_jsxs("button", { className: `mode-button ${manualRequestMode === 'external' ? 'active karaoke-nerds' : ''}`, onClick: () => setManualRequestMode('external'), children: [_jsx("img", { src: "https://karaokenerds.com/Content/Icons/favicon.ico", alt: "Karaoke Nerds", className: "mode-icon", style: { width: "20px", height: "20px", marginRight: "6px" } }), "External"] })), _jsxs("button", { className: `mode-button ${manualRequestMode === 'url' ? 'active' : ''}`, onClick: () => setManualRequestMode('url'), children: [_jsx(MaterialIcon, { name: "link", style: { fontSize: 18, marginRight: 6 } }), " URL"] })] }), manualRequestMode === 'url' ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { className: "form-label", children: "Video URL" }), _jsx("input", { className: "form-input", placeholder: "Enter YouTube or video URL...", value: manualRequestUrl, onChange: e => setManualRequestUrl(e.target.value), autoFocus: true, style: {
                                                                    width: '100%',
                                                                    boxSizing: 'border-box',
                                                                    marginBottom: '16px'
                                                            ...
                                                            manualRequestResults.map((track) => (_jsxs("div", { className: "search-result", onClick: () => addManualRequestLocal(track.id), children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { style: { fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: track.title || 'Unknown' }), _jsxs("div", { style: { fontSize: 13, color: 'var(--color-text-secondary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: [track.artist || 'Unknown', track.disc_id && (_jsx("span", { style: {
                                                                        ...
                                                                        }, disabled: busy, "aria-label": "Add to queue", title: "Add to queue", children: busy ? '…' : _jsx(MaterialIcon, { name: "add", style: { fontSize: 16 } }) })] }, track.id)))) : (
                                                            // External results
                                                            manualRequestResults.map((track, idx) => (_jsxs("div", { className: "search-result", onClick: () => addManualRequestExternal(track), children: [_jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { style: { fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: track.title || 'Unknown' }), _jsxs("div", { style: { fontSize: 13, color: 'var(--color-text-secondary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: [track.artist || 'Unknown', track.brand && (_jsx("span", { style: {
                                                                                    ...
                                                                                    e.stopPropagation();
                                                                                    downloadVideo(track.url, track.title, track.artist, track.brand);
                                                                                }, disabled: busy || downloadingTrack === track.url, "aria-label": downloadingTrack === track.url ? 'Downloading to local library' : 'Download to local library', title: "Download to local library", children: _jsx(MaterialIcon, { name: downloadingTrack === track.url ? 'hourglass_top' : 'download', style: { fontSize: 16 } }) })), _jsx("button", { className: "control-btn", style: {
                                                                                    padding: '6px 10px',
                                                                                    fontSize: '13px',
                                                                                    minWidth: '40px',
                                                                                    background: 'linear-gradient(135deg, #7c3aed, #a855f7)'
                                                                                ...
                                                                                }, disabled: busy, "aria-label": "Add to queue", title: "Add to queue", children: busy ? '…' : _jsx(MaterialIcon, { name: "add", style: { fontSize: 16 } }) })] })] }, track.url || idx)))) })) })] })), _jsx("button", { className: "control-btn", style: {
                                                    width: '100%',
                                                    background: 'transparent',
                                                    border: '2px solid var(--color-border)'
