      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h1", {
            ...
            children: "\uD83C\uDF10 Karaoke Nerds Search",
          }),
          _jsxs("div", {
            className: "info-banner",
            children: [
              _jsx("strong", { children: "\uD83C\uDFB5 KaraokeDock:" }),
              " Search and play songs from KaraokeNerds.com directly in your browser!",
            ],
          }),
          _jsxs("div", {
            ...
            children: [
              _jsxs("label", {
                className: "label",
                htmlFor: "requested-by-input",
                children: [
                  "Your Name",
                  _jsx("span", { className: "required-star", children: "*" }),
                  _jsx("span", {
                    style: {
                      fontSize: 12,
                    ...
                    children: "(required to add songs)",
                  }),
                ],
              }),
              _jsx("input", {
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsxs("span", {
                      children: [
                        "Singing as: ",
                        _jsx("strong", { children: requestedBy.trim() }),
                      ],
                    }),
                  ],
                }),
          ...
          busy &&
            _jsx("div", {
              style: { marginTop: 12, color: "rgba(229,231,235,.6)" },
              children: "\uD83D\uDD0D Searching Karaoke Nerds...",
            }),
          results.length > 0 &&
            _jsxs("table", {
              children: [
                ...
                _jsx("tbody", {
                  children: results.map((track, idx) =>
                    _jsxs(
                      "tr",
                      {
                        children: [
                          ...
                          _jsx("td", {
                            style: { color: "rgba(229,231,235,.8)" },
          ...
          !results.length &&
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  children: ['No songs found on Karaoke Nerds for "', q, '"'],
                }),
                _jsx("div", {
