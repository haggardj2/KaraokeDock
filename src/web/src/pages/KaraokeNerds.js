...
export default function KaraokeNerds() {
    ...
    return (_jsxs("div", { style: {
      ...
      ` }), _jsxs("div", { className: "card", children: [_jsx("h1", { style: { marginTop: 0, marginBottom: 12 }, children: "\uD83C\uDF10 Karaoke Nerds Search" }), _jsxs("div", { className: "info-banner", children: [_jsx("strong", { children: "\uD83C\uDFB5 KaraokeDock:" }), " Search and play songs from KaraokeNerds.com directly in your browser!"] }), _jsxs("div", { className: "field-group", children: [_jsxs("label", { className: "label", htmlFor: "requested-by-input", children: ["Your Name", _jsx("span", { className: "required-star", children: "*" }), _jsx("span", { style: {
                            ...
                            padding: "40px 20px",
                            color: "rgba(229,231,235,.5)",
                        }, children: [_jsx("div", { style: { fontSize: 48, marginBottom: 12 }, children: "\uD83C\uDF10" }), _jsx("div", { style: { fontSize: 18, fontWeight: 500 }, children: "Search KaraokeDock" }), _jsx("div", { style: { fontSize: 14, marginTop: 8 }, children: "Enter your name above, then search for songs from Karaoke Nerds!" })] }))] })] }));
}
