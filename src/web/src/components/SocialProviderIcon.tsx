...
export default function SocialProviderIcon({ provider, size = 40 }: { provider: SocialProvider; size?: number }) {
  if (provider === 'google') {
    return <img src={googleSignIn} width={size} height={size} alt="" aria-hidden="true" />
  }
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <circle cx="12" cy="12" r="11.9" fill="white" />
